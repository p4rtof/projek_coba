                ...
                <div class="card shadow-sm border-0 rounded-4">
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                <label class="small text-muted fw-bold">Jenis Satuan</label>
                            ...
                            <?php if($edit_data): ?>
                                <a href="index.php" class="btn btn-light w-100 mt-2 rounded-pill text-muted">Batal Edit</a>
                            <?php endif; ?>
                        </form>
                    </div>
                </div>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-dark fw-bold"><?= $row['stok_bahan'] ?></span>
                                        </td>

                                        <td class="text-primary fw-bold">Rp <?= number_format($row['harga'], 0, ',', '.') ?></td>

                                        <td class="text-end pe-4">
                                            <a href="index.php?edit=<?= $row['id_produk'] ?>" class="btn btn-sm btn-outline-primary rounded-circle me-1" title="Edit"><i class="bi bi-pencil-fill"></i></a>
                                            <a href="index.php?hapus=<?= $row['id_produk'] ?>" onclick="return confirm('Yakin hapus produk ini?')" class="btn btn-sm btn-outline-danger rounded-circle" title="Hapus"><i class="bi bi-trash-fill"></i></a>
                                        </td>
                                    </tr>
                                    <?php 
                                        endwhile; 
