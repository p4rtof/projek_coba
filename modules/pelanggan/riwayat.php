...
<head>
    ...
    <style>
        ...
        .info-pill { background: white; border: 1px solid var(--border); padding: 8px 16px; border-radius: 50px; font-size: 0.85rem; color: var(--secondary); display: inline-flex; align-items: center; gap: 8px; }
            ...
            <div class="row align-items-center">
                <div class="col-md-7 customer-header">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        <div class="info-pill"><i class="bi bi-telephone-fill text-success"></i> <?= $p['hp'] ?? '-' ?></div>
                        ...
                        <tbody>
                            <?php if ($total_riwayat > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-start fw-bold text-dark" style="min-width: 150px; max-width: 250px;"><?= $r['nama_produk'] ?></td>
                                    ...
                                    <td class="text-nowrap">
                                        <?php $st = $r['status_order']; 
                                        if($st == 'Done'): ?><span class="text-success fw-bold small"><i class="bi bi-check-all fs-5"></i> DONE</span>
                                        <?php elseif($st == 'Selesai'): ?><span class="badge badge-status bg-soft-info">Siap Ambil</span>
                                        <?php else: ?><span class="badge badge-status bg-soft-warning">Proses</span><?php endif; ?>
                                    </td>
                                            ...
                                            <?php if ($r['status_pembayaran'] == 'Belum Lunas'): ?>
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu shadow border-0">
                                                        ...
                                                        <li><a class="dropdown-item" href="riwayat.php?id=<?= $id_pelanggan ?>&lunasi_item=true&uid=<?= $r['id'] ?>" onclick="return confirm('Lunasi ITEM ini saja?')">Item Ini Saja</a></li>
                                                        <li><a class="dropdown-item" href="riwayat.php?id=<?= $id_pelanggan ?>&lunasi_nota=true&id_trx=<?= $r['id_transaksi'] ?>" onclick="return confirm('Lunasi SEMUA di nota ini?')">Satu Nota</a></li>
                                                    </ul>
                                                </div>
                                            <?php endif; ?>

                                            <a href="../transaksi/edit.php?id=<?= $r['id_transaksi'] ?>" class="btn-icon btn-blue" title="Edit"><i class="bi bi-pencil-square"></i></a>
                                            <a href="../transaksi/invoice.php?item_id=<?= $r['id'] ?>" class="btn-icon btn-gray" title="Cetak"><i class="bi bi-printer"></i></a>
