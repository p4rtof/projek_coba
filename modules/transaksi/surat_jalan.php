...
// --- [LOGIKA NAMA FILE PDF] ---
// Ambil No Invoice
$no_invoice_raw = $first_row['id_transaksi'];

// Bersihkan karakter ilegal untuk nama file (seperti / \ : * ? " < > |)
// Ubah "INV/2025/001" menjadi "INV-2025-001"
$safe_invoice = str_replace(['/', '\\', ':', '*', '?', '"', '<', '>', '|'], '-', $no_invoice_raw);

// Jika cetak banyak (gabungan), beri nama khusus
if (count(array_unique($ids_to_check)) > 1) {
    $judul_halaman = "Surat Jalan GABUNGAN";
} else {
    $judul_halaman = "Surat Jalan " . $safe_invoice;
}
...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .table-sj, .table-sj th, .table-sj td { border: 1px solid #000 !important; }
        ...
        <div class="sj-box">
            ...
            <div class="row align-items-start mb-2">
                ...
                <div class="col-5 text-end align-self-center">
                    ...
                    <table style="width: auto; margin-left: auto; text-align: left; margin-top: 15px; font-size: 0.95rem;">
                        <tr>
