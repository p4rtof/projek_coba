...
<head>
    ...
    <style>
        ...
        .label-col { width: 120px; color: #333; } /* Lebar label tetap */
        ...
        .col-data { text-align: center; font-weight: bold; }
        ...
        @media print {
            ...
            .table-custom, .table-custom th, .table-custom td { border: 1px solid #000 !important; }
        }
    </style>
</head>
<body>
        ...
        <tbody>
            ...
            <tr>
                ...
                if(isset($values[$index])) {
                    ...
                    foreach($headers as $h) { echo "<td class='col-data'>-</td>"; }
                }
                ?>
            </tr>
            <?php 
            ...
            ?>
                <tr><td colspan="<?= count($headers) + 1 ?>" class="text-center py-3">- Tidak ada item -</td></tr>
            <?php endif; ?>
        </tbody>
    </table>
