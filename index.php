...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 mt-5">
            ...
            <a href="modules/transaksi/baru.php" class="btn btn-primary shadow-sm rounded-pill px-4 py-2 fw-bold">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="border-bottom: 1px solid #f0f0f0;">
                                    ...
                                    <td class="small text-muted"><?= date('d M y (H:i)', strtotime($r['waktu_order'])) ?></td>
