...
<head>
    ...
    <style>
        ...
        .animate-fade-2 { animation: fadeInUp 0.3s ease-out 0.2s forwards; opacity: 0; }
        .animate-fade-3 { animation: fadeInUp 0.3s ease-out 0.4s forwards; opacity: 0; }
                    ...
                    <table class="table table-custom mb-0 text-center">
                        <thead>
                            <tr>
                                ...
                                <th class="text-start"style="min-width: 200px;">Pelanggan</th>
                        ...
                        <tbody>
                            <?php if (pg_num_rows($q_transaksi) > 0): ?>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td class="text-end pe-4 text-nowrap">
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <a href="modules/transaksi/invoice.php?id=<?= $r['id_transaksi'] ?>" target="_blank" class="btn-icon btn-gray" title="Print Invoice Full"><i class="bi bi-printer"></i></a>
                                ...
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr><td colspan="7" class="text-center py-5 text-secondary"><i class="bi bi-receipt-cutoff fs-1 d-block mb-2 opacity-25"></i>Tidak ada data transaksi ditemukan.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
